...
class TypingSpeedTester(tk.Tk):
    def __init__(self):
        ...
        self.words = ["Hello world, Welcome to typingspeed tester!", "Python", "Speed", "Tester", "This is python programming.", "Great to learn new things, Hurray!"]
        self.current_word = ""
        self.start_time = None

        self.title("Typing Speed Tester Project")
    ...
    def check_word(self,event):
        ...
        if typed_word == self.current_word:
            ...
            self.result_label.config(text=f"Your typing speed is: {wpm} WPM, Good Performance!", fg="white")
        else:
            self.result_label.config(text="Wrong word try again!", fg="white")

            self.after(20, self.get_new_word)
